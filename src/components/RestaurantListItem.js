...
class RestaurantListItem extends React.Component {
  ...
  render() {
    ...
    return !this.state.isMobile ? (
      <div
        className={
          this.props.mode.mode ? "list--item dark-accent" : "list--item"
        }
        key={this.props.id}
      >
        ...
        <div className="address__container">
          ...
          <div className="address__container--favorite">
            <i
              className={`${
                this.props.mode.mode
                  ? "far fa-heart dark-icon"
                  : "far fa-heart light-icon"
              } `}
              onClick={e => {
              ...
              style={
                this.favoritesList.includes(this.props.spot.name)
                  ? { ...styles }
                  : null
              }
            />
      ...
      >
        <div className="list--item--top">
          <div className="img-container">{this.getPhotos()}</div>
          <div
            className="ramen__title"
            style={{
              borderLeft: `${
                this.props.mode.mode ? "1px solid #555" : "1px solid #eee"
              }`
            }}
          >
