...
const RamenList = ({ mode, restaurants, loading, addFavorite, favorites }) => {
      ...
      <RestaurantListItem
        ...
        open={
          spot.opening_hours
            ...
            : (spot.opening_hours = { open_now: "n/a" })
        }
  ...
  if (loading && restaurants.length < 1) {
    return (
      <div
        className={
          mode.mode ? "ramen__list--container dark" : " ramen__list--container"
        }
      >
  ...
  return (
    ...
    >
      <div
        className={
          mode.mode
            ? "ramen__list--container--enter dark"
            : "ramen__list--container--enter"
        }
      ...
      >
        <img
          ...
          className="logo"
        />
        <p style={{ color: `${mode.mode ? "#666" : "#999"}` }}>
